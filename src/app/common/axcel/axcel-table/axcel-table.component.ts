import { Component, AfterViewInit, Input, QueryList, ViewChild, ContentChildren, ElementRef } from '@angular/core';
...
export class AxcelTableComponent implements AfterViewInit {
  @Input() ruler: string;
